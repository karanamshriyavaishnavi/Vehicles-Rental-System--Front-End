...
const vehicalAdding = async(e:React.FormEvent<HTMLFormElement>) =>{
  ...
  try{
    const response = await AxiosApi.post(`api/owner/vehical/${owner._id}`,formdata)
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded-md shadow-md mt-4 ">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="mb-4">
          <label htmlFor="brand" className="block text-sm font-medium text-gray-700">city</label>
            <input type="text" id="brand" name="city" onChange={handlechange}  className="mt-1 p-2 border rounded-md w-full" required />
          </div>
          <div className="mb-4">
          <label htmlFor="brand" className="block text-sm font-medium text-gray-700">State</label>
            <input type="text" id="brand" name="state" onChange={handlechange}  className="mt-1 p-2 border rounded-md w-full" required />
          </div>
          <div className="mb-4">
